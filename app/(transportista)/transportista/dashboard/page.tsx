  ...
  return (
    <div className="min-h-screen" style={{ backgroundColor: "#F2F5F5" }}>
      ...
      <main className="max-w-lg mx-auto px-6 py-10">
        <div className="mb-8">
          <h2 className="text-3xl font-bold text-gray-900">Panel de Transportista</h2>
        ...
        <div className="flex flex-col gap-3 mb-8">
          ...
          >
            ...
            {totalCargas > 0 && (
              <span className="ml-1 text-xs font-bold px-2 py-0.5 rounded-full" style={{ backgroundColor: "#0A1A1A", color: "var(--primary)" }}>
                {totalCargas}
              </span>
            )}
          </Link>
          ...
          >
            ...
            Mis postulaciones
            {misPostulaciones > 0 && (
              <span className="ml-1 text-xs font-bold px-2 py-0.5 rounded-full" style={{ backgroundColor: "var(--primary)", color: "#0C1E1E" }}>
                {misPostulaciones}
              </span>
            )}
          </Link>
