...
export default async function EmpresaConversacionesPage() {
  ...
  const conversaciones = await findConversaciones(session.userId, "empresa");
      ...
      <main className="max-w-2xl mx-auto px-5 py-6">
        <div className="mb-6">
          ...
          <p className="text-sm" style={{ color: "#6B7280" }}>
            Coordiná con los transportistas asignados a tus cargas
          </p>
        </div>
        ...
        {conversaciones.length === 0 ? (
          ...
          >
            ...
            <p style={{ color: "#374151" }}>
              Todavía no tenés conversaciones. Cuando aceptes un transportista para una carga, vas a poder chatear acá.
            </p>
          </div>
        ) : (
